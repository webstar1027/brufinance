...
export interface InterestTokenInterface extends utils.Interface {
  functions: {
    ...
    "changeTransferStatus()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "changeTransferStatus",
    values?: undefined
  ): string;
...
export interface InterestToken extends BaseContract {
  ...
  callStatic: {
    ...
    changeTransferStatus(overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    NameChanged(newName?: null, by?: null): NameChangedEventFilter;
